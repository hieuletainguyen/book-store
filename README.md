...
To start the project, run ```docker compose up -d``` in the main folder.

The book store app will be run on localhost:3000

The book store backend will be run on port 9897.

The database will be run on port 3306.
